          ...
          <div class="checkout-form">
            ...
            <form @submit.prevent="confirmOrder">
              <div class="form-group">
                ...
                <input type="text" v-model="username" disabled class="form-input">
              </div>
              <div class="form-group">
                <label for="phone" class="label">Số điện thoại:</label>
                <input type="text" v-model="phone" disabled class="form-input">
              </div>
              <div class="form-group">
                <label for="address" class="label">Địa chỉ:</label>
                <input type="text" v-model="address" disabled class="form-input">
              </div>
